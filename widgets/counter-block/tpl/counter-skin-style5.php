...
?>
<div class="counter-block-five uae-counter <?php echo esc_attr($animation);?>" data-wow-delay="<?php echo esc_attr($animation_delay);?>">
	<div class="inner">
		<?php if ( $show_icon_image == 'yes' ): ?>
			<?php unique_addons_get_shortcode_template_part( 'icon-type', $icon_type, 'counter-block/tpl', $settings, false );?>
		<?php endif;?>
	    <div class="count-box">
