...
class TM_Elementor_Clients_logo extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		wp_register_style( 'tm-clients-logo-style', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/clients-logo' . $direction_suffix . '.css' );
	}
	...
	public function get_title() {
		return esc_html__( 'Clients Logo', 'siddik-layout-widgets-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'tm_items_section',
			[
				'label' => esc_html__( 'Items', 'siddik-layout-widgets-elementor' ),
		...
		$repeater->add_control(
			'logo', [
				'label' => esc_html__( "Logo", 'siddik-layout-widgets-elementor' ),
		...
		$repeater->add_control(
			'logo_url',
			[
				'label' => esc_html__( "URL", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
			]
		);
		$repeater->add_control(
			'link_target', [
				'label' => esc_html__( "Link Target", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'_blank'  =>  esc_html__( 'Opens in a new window or tab', 'siddik-layout-widgets-elementor' ),
					'_self' =>  esc_html__( 'Opens in the same window', 'siddik-layout-widgets-elementor' ),
				],
				'default' => '_blank'
			]
		);
		$this->add_control(
			'clients_logo_array',
			[
				'label' => esc_html__( "Clients Logo", 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Hover Animation Type", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'clients-animation-no-effect' =>  esc_html__( 'No Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-grayscale' =>  esc_html__( 'Grayscale Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-opacity' =>  esc_html__( 'Opacity Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-blur'  =>  esc_html__( 'Blur Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-zoom'  =>  esc_html__( 'Zoom Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-contrast'  =>  esc_html__( 'Contrast Effect', 'siddik-layout-widgets-elementor' ),
					'clients-animation-invert'  =>  esc_html__( 'Invert Effect', 'siddik-layout-widgets-elementor' ),
				],
		...
		$this->add_control(
			'rollover_effect',
			[
				'label' => esc_html__( "Make Roll Over Effect", 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'logo_filter_options',
			[
				'label' => esc_html__( 'Filter Options', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'logo_filter_white',
			[
				'label' => esc_html__( 'Filter Logo to White', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Logo to White (Hover)', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			'logo_filter_black',
			[
				'label' => esc_html__( 'Filter Logo to Black', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Logo to Black (Hover)', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_section(
			'each_logo_styling',
			[
				'label' => esc_html__( 'Each Logo Styling', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Vertical Alignment", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Horizontal Alignment", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label' => esc_html__( 'Column Gap', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo Area Custom Width", 'siddik-layout-widgets-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Logo/Image Custom Width", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'separator' => 'before',
				'size_units' => [ 'px', '%' ],
				'default' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('First Child', 'siddik-layout-widgets-elementor'),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Child', 'siddik-layout-widgets-elementor'),
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		$html = unique_addons_get_widgetcore_template_part( 'clients', $settings['display_type'], 'clients-logo/tpl', $settings, true );
