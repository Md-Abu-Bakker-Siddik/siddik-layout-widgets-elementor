...
if ( ! function_exists( 'unique_addons_theme_color_list' ) ) {
	/**
	 * Theme Color list
	 */
	function unique_addons_theme_color_list() {
		$theme_color_list = array(
			'' => esc_html__( 'No', 'siddik-layout-widgets-elementor' ),
			'1' => esc_html__( 'Theme Color 1', 'siddik-layout-widgets-elementor' ),
			'2' => esc_html__( 'Theme Color 2', 'siddik-layout-widgets-elementor' ),
			'3' => esc_html__( 'Theme Color 3', 'siddik-layout-widgets-elementor' ),
			'4' => esc_html__( 'Theme Color 4', 'siddik-layout-widgets-elementor' )
		);
		return $theme_color_list;
	}
}

if(!function_exists('unique_addons_number_of_theme_colors')) {
	/**
	 * Number of Theme Colors Used in this theme
	 */
	function unique_addons_number_of_theme_colors() {
		return 4;
	}
}

if(!function_exists('unique_addons_icon_font_packs')) {
	/**
	 * Theme Color list
	 */
	function unique_addons_icon_font_packs( $icon_type = 'font_awesome' ) {
		unset( $icon_type );
		return array();
	}
}

if(!function_exists('unique_addons_animate_css_animation_list')) {
	/**
	 * animate.css animation list https://daneden.github.io/animate.css/
	 */
	function unique_addons_animate_css_animation_list() {
...
if(!function_exists('unique_addons_custom_animation_class_list')) {
	/**
	 * custom made animation list
	 */
	function unique_addons_custom_animation_class_list() {
		$class_list = array(
			''	=>	esc_html__( "None", 'siddik-layout-widgets-elementor' ),
			'fade-in'	=>	esc_html__( "fade-in", 'siddik-layout-widgets-elementor' ),
			'move-up'	=>	esc_html__( "move-up", 'siddik-layout-widgets-elementor' ),
			'move-down'	=>	esc_html__( "move-down", 'siddik-layout-widgets-elementor' ),
			'move-left'	=>	esc_html__( "move-left", 'siddik-layout-widgets-elementor' ),
			'move-right'	=>	esc_html__( "move-right", 'siddik-layout-widgets-elementor' ),
			'scale-up'	=>	esc_html__( "scale-up", 'siddik-layout-widgets-elementor' ),
			'fall-perspective'	=>	esc_html__( "fall-perspective", 'siddik-layout-widgets-elementor' ),
			'fly'	=>	esc_html__( "fly", 'siddik-layout-widgets-elementor' ),
			'flip'	=>	esc_html__( "flip", 'siddik-layout-widgets-elementor' ),
			'helix'	=>	esc_html__( "helix", 'siddik-layout-widgets-elementor' ),
			'pop-up'	=>	esc_html__( "pop-up", 'siddik-layout-widgets-elementor' )
		);
		return $class_list;
	}
}

if(!function_exists('unique_addons_jquery_easings_list')) {
	/**
	 * easings list http://api.jqueryui.com/easings/
	 */
	function unique_addons_jquery_easings_list() {
...
if(!function_exists('unique_addons_orderby_parameters_list')) {
	/**
	 * Orderby Parameters list
	 */
	function unique_addons_orderby_parameters_list() {
		$orderby_parameters_list = array(
			'date'	=>	esc_html__( 'Date', 'siddik-layout-widgets-elementor' ),
			'name'	=>	esc_html__( 'Post Name', 'siddik-layout-widgets-elementor' ),
			'rand'	=>	esc_html__( 'Random Order', 'siddik-layout-widgets-elementor' ),
			'modified'	=>	esc_html__( 'Last Modified Date', 'siddik-layout-widgets-elementor' ),
			'author'	=>	esc_html__( 'Author', 'siddik-layout-widgets-elementor' ),
			'title'	=>	esc_html__( 'Title', 'siddik-layout-widgets-elementor' ),
			'ID'	=>	esc_html__( 'ID', 'siddik-layout-widgets-elementor' ),
			'parent'	=>	esc_html__( 'Post/Page Parent ID', 'siddik-layout-widgets-elementor' ),
			'comment_count'	=>	esc_html__( 'Number of Comments', 'siddik-layout-widgets-elementor' ),
			'menu_order'	=>	esc_html__( 'Page Order', 'siddik-layout-widgets-elementor' )
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('unique_addons_category_orderby_parameters_list')) {
	/**
	 * Category Orderby Parameters list
	 */
	function unique_addons_category_orderby_parameters_list() {
		$orderby_parameters_list = array(
			esc_html__( 'name', 'siddik-layout-widgets-elementor' ) 	=> 'name',
			esc_html__( 'id', 'siddik-layout-widgets-elementor' ) 		=> 'id',
			esc_html__( 'count', 'siddik-layout-widgets-elementor' ) 	=> 'count',
			esc_html__( 'slug', 'siddik-layout-widgets-elementor' ) 	=> 'slug',
		);
		return $orderby_parameters_list;
	}
}

if(!function_exists('unique_addons_isotope_gutter_list')) {
	/**
	 * Gutter list
	 */
	function unique_addons_isotope_gutter_list() {
		if ( function_exists( 'unique_addons_isotope_gutter_list_elementor' ) ) {
			return unique_addons_isotope_gutter_list_elementor();
		}
...
if(!function_exists('unique_addons_different_size_list')) {
	/**
	 * Size list
	 */
	function unique_addons_different_size_list() {
		return array(
			''                      => esc_html__( 'Default', 'siddik-layout-widgets-elementor' ),
			'uae_wide'      => esc_html__( 'Width', 'siddik-layout-widgets-elementor' ),
			'uae_height'    => esc_html__( 'Height', 'siddik-layout-widgets-elementor' ),
			'uae_width_height' => esc_html__( 'Both Width & Height', 'siddik-layout-widgets-elementor' ),
		);
	}
}

if(!function_exists('unique_addons_get_post_all_categories_array')) {
	/**
	 * Category List of Blog Posts as an Array
	 */
	function unique_addons_get_post_all_categories_array() {
		$categories = get_categories( array(
			'orderby' => 'name',
			'order'   => 'ASC'
		) );
		$cats = array();
		$cats[''] = esc_html__( 'All', 'siddik-layout-widgets-elementor' );
...
if(!function_exists('unique_addons_get_page_list_array')) {
	/**
	 * Category List of Pages as an Array
	 */
	function unique_addons_get_page_list_array() {
		$all_pages = get_pages();
		$pages = array();
...
if ( ! function_exists( 'unique_addons_metabox_get_list_of_predefined_theme_color_css_files' ) ) {
	/**
	 * Get list of Predefined Theme Color css files
	 */
	function unique_addons_metabox_get_list_of_predefined_theme_color_css_files() {
		$predefined_theme_colors = array();
		$colors_dir              = UNIQUE_ADDONS_ABS_PATH . 'assets/css/colors/';

		if ( is_dir( $colors_dir ) && ( $handle = opendir( $colors_dir ) ) ) {
...
if ( ! function_exists( 'unique_addons_category_list_array' ) ) {
	/**
	 * Return category list array
	 */
	function unique_addons_category_list_array( $taxonomy ) {
...
if ( ! function_exists( 'unique_addons_load_styles' ) ) {
	/**
	 * Get style array
	 */
	function unique_addons_load_styles( $qty = 1, $param_name = 'design_style', $admin_label = false ) {
		$options = array();
		for ($i = 1; $i <= $qty; $i++) {
			$options[sprintf(esc_html__("Style %s", 'siddik-layout-widgets-elementor'), $i)] = "style{$i}";
		}

		$array = array(
			'type'       => 'dropdown',
			'heading'    => esc_html__('Design Style', 'siddik-layout-widgets-elementor'),
...
if(!function_exists('unique_addons_get_post_list_array_by_post_type_old')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function unique_addons_get_post_list_array_by_post_type_old( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$args = array(
			'post_type'			=> $cpt,
			'posts_per_page'	=> -1,
...
if(!function_exists('unique_addons_get_post_list_array_by_post_type')) {
	/**
	 * Return Post List Array By Post Type
	 */
	function unique_addons_get_post_list_array_by_post_type( $cpt = '', $for_vc = false ) {
		$post_list = array();
		$post_list[''] = esc_html__( "Select Item", 'siddik-layout-widgets-elementor' );
		$args = array(
			'post_type'			=> $cpt,
			'numberposts'		=> -1,
			'orderby'			=> 'title',
...
if ( ! function_exists( 'unique_addons_set_admin_ajax_url' ) ) {
	/**
	 * Expose admin-ajax.php URL to frontend scripts.
	 *
	 * @return void
	 */
	function unique_addons_set_admin_ajax_url() {
		wp_register_script( 'slwe-admin-ajax', false, array(), UNIQUE_ADDONS_VERSION, true );
		wp_enqueue_script( 'slwe-admin-ajax' );
		wp_add_inline_script(
			'slwe-admin-ajax',
			'var uniqueAddonsAjaxUrl = ' . wp_json_encode( admin_url( 'admin-ajax.php' ) ) . ';',
			'before'
		);
	}
	add_action( 'wp_enqueue_scripts', 'unique_addons_set_admin_ajax_url' );
}

if(!function_exists('unique_addons_row_typography')){
	/**
	 * Return Row Typography Array
	 *
	 */
	function unique_addons_row_typography() {
		$array = array();

		$array = array(
			"type"			=> 'dropdown',
			"heading"		=> esc_html__( "Row Typography", 'siddik-layout-widgets-elementor' ) ,
			"param_name"	=> "section_typo",
			"description"	=> esc_html__( "Define the color typography of the text of this row.", 'siddik-layout-widgets-elementor' ) ,
			"value" => array(
				esc_html__( 'Default', 'siddik-layout-widgets-elementor' ) => '',
				esc_html__( 'Light Typography - on Dark Background', 'siddik-layout-widgets-elementor' ) => 'section-typo-light',
				esc_html__( 'Dark Typography - on White Background', 'siddik-layout-widgets-elementor' ) => 'section-typo-dark',
			) ,
			"weight" => "99"
		);
...
if(!function_exists('unique_addons_get_animation_type')) {
	...
	function unique_addons_get_animation_type() {
		$array = array(
			...
			esc_html__( 'Floating Animation', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-floating',
			esc_html__( 'Horizontal Slide Animation', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-slide-horizontal',

			esc_html__( 'Flicker Animation', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-flicker',
			esc_html__( 'Spin Animation', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-spin',


			esc_html__( 'Random Animation 1', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-random-animation1',
			esc_html__( 'Random Animation 2', 'siddik-layout-widgets-elementor' )	=>	'tm-animation-random-animation2',
		);
		return $array;
	}
}
...
if(!function_exists('unique_addons_masonry_image_sizes')) {
	 ...
	 */
	function unique_addons_masonry_image_sizes() {
		$masonry_image_sizes = array(
			'uae_square'			=> esc_html__( 'Default', 'siddik-layout-widgets-elementor' ),
			'uae_wide'			=> esc_html__( 'Width', 'siddik-layout-widgets-elementor' ),
			'uae_height'			=> esc_html__( 'Height', 'siddik-layout-widgets-elementor' ),
			'uae_width_height'	=> esc_html__( 'Both Width & Height', 'siddik-layout-widgets-elementor' ),
		);
...
if(!function_exists('unique_addons_heading_tag_list')) {
	/**
	 * Heading Tag List
	 */
	function unique_addons_heading_tag_list() {
...
if(!function_exists('unique_addons_wp_admin_dashicons_list')) {
	/**
	 * WordPress admin Dashicons https://developer.wordpress.org/resource/dashicons
	 */
	function unique_addons_wp_admin_dashicons_list() {
		$animate_css_animation_list = array(
			'' => '',
...
if ( ! function_exists( 'unique_addons_prepare_button_classes_from_params' ) ) {
	/**
	 * Return Button Classes Collecting From Params
	 */
	function unique_addons_prepare_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'unique_addons_prepare_header_button_classes_from_params' ) ) {
	/**
	 * Return Header Button Classes Collecting From Params
	 */
	function unique_addons_prepare_header_button_classes_from_params( $params = array(), $prefix = '' ) {
		$btn_classes = array();
...
if ( ! function_exists( 'unique_addons_swiper_data_params' ) ) {
	/**
	 * Return Swiper Slider Data Collecting From Params
	 */
	function unique_addons_swiper_data_params( $params = array(), $prefix = '' ) {
		$swiper_data = array();
...
if(!function_exists('unique_addons_get_swiper_slider_arraylist')) {
	/**
	 * Return Swiper Slider Array List
	 */
	function unique_addons_get_swiper_slider_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		//Swiper Slider Options
		$control_object->start_controls_section(
			'carousel_options', [
				'label' => esc_html__( 'Carousel/Slider Options', 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_control(
			$prefix . "xxl_swiper_items", [
				'label' => esc_html__( "Items Extra Extra Large (Over 1400px)", 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_control(
			$prefix . "swiper_items", [
				'label' => esc_html__( "Items Extra Large(Over 1200px)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "lg_swiper_items", [
				'label' => esc_html__( "Items Large (Between 992px to 1200px)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "md_swiper_items", [
				'label' => esc_html__( "Items Medium (Over 768px)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "sm_swiper_items", [
				'label' => esc_html__( "Items Small (Over 576px)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "xs_swiper_items", [
				'label' => esc_html__( "Items Extra Small (Below 576px)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  =>  '1',
					'2'  =>  '2',
		...
		$control_object->add_control(
			$prefix . "arrow", [
				'label' => esc_html__( "Show Arrow", 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_control(
			$prefix . "bullets", [
				'label' => esc_html__( "Show Pagination/Bullets", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'pagination_type', [
				'label' => esc_html__( "Pagination/Bullets Type", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'bullets' => esc_html__( 'Bullets', 'siddik-layout-widgets-elementor' ),
					'fraction' => esc_html__( 'Fraction', 'siddik-layout-widgets-elementor' ),
					'progressbar' => esc_html__( 'Progressbar', 'siddik-layout-widgets-elementor' ),
				],
				'default' => 'bullets',
				'condition' => [
		...
		$control_object->add_control(
			$prefix . 'slide_effect',
			[
				'label'   => esc_html__( 'Slide Effect', 'siddik-layout-widgets-elementor' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => [
					'slide'     => esc_html__( 'Slide', 'siddik-layout-widgets-elementor' ),
					'fade'     => esc_html__( 'Fade', 'siddik-layout-widgets-elementor' ),
					'flip'      => esc_html__( 'Flip', 'siddik-layout-widgets-elementor' ),
					'cube'      => esc_html__( 'Cube', 'siddik-layout-widgets-elementor' ),
					'coverflow' => esc_html__( 'CoverFlow', 'siddik-layout-widgets-elementor' ),
					'cards' => esc_html__( 'Cards', 'siddik-layout-widgets-elementor' ),
				],
			]
		);
		//================ start popover
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'CoverFlow Settings', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'siddik-layout-widgets-elementor' ),
				'label_on' => esc_html__( 'Custom', 'siddik-layout-widgets-elementor' ),
				'return_value' => 'yes',
				'default' => 'no',
				'condition' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Rotate', 'siddik-layout-widgets-elementor'),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Stretch', 'siddik-layout-widgets-elementor'),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -500,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Depth', 'siddik-layout-widgets-elementor'),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Modifier', 'siddik-layout-widgets-elementor'),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Scale', 'siddik-layout-widgets-elementor'),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 0.1,
				'max' => 2,
				'step' => 0.1,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__('Slide Shadows', 'siddik-layout-widgets-elementor'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'siddik-layout-widgets-elementor'),
				'label_off' => esc_html__('No', 'siddik-layout-widgets-elementor'),
				'return_value' => 'yes',
				'default' => 'yes',
			]
		);
		...
		$control_object->add_control(
			$prefix . "autoplay", [
				'label' => esc_html__( "Autoplay", 'siddik-layout-widgets-elementor' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
		...
		$control_object->add_control(
			$prefix . 'delay',
			[
				'label' => esc_html__( 'Delay (ms)', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 3000,
				'description' => esc_html__( "Time between slides in ms", 'siddik-layout-widgets-elementor' ),
				'condition' => [
						$prefix . 'autoplay' => 'yes',
				],
			]
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Disable on Interaction', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Keep autoplay running after user swipes", 'siddik-layout-widgets-elementor' ),
				'default' => 'false',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Pause On Mouse Enter', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Pause autoplay when mouse hovers over slider", 'siddik-layout-widgets-elementor' ),
				'default' => 'yes',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			$prefix . "reversedir", [
				'label' => esc_html__( "Reverse Direction", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'description' => esc_html__( "Play slides in reverse order", 'siddik-layout-widgets-elementor' ),
				'default' => 'no',
				'condition' => [
					$prefix . 'autoplay' => 'yes',
				],
		...
		$control_object->add_control(
			...
			[
				'label'     => esc_html__( 'Allow Touch Move', 'siddik-layout-widgets-elementor' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		...
		$control_object->add_control(
			$prefix . "loop", [
				'label' => esc_html__( "Infinite Loop", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "centered", [
				'label' => esc_html__( "Enabled Centered", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . 'space',
			[
				'label' => esc_html__( 'Space (px)', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_control(
			$prefix . 'speed',
			[
				'label' => esc_html__( 'Animation Speed (ms)', 'siddik-layout-widgets-elementor' ),
				'description' => esc_html__( "Duration in milliseconds (default is 300ms)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => 300,
				'condition' => $dependency
			]
		...
		$control_object->add_control(
			$prefix . "freemod", [
				'label' => esc_html__( "Free Mode", 'siddik-layout-widgets-elementor' ),
				'description' => esc_html__( "Scroll freely through slides", 'siddik-layout-widgets-elementor' ),
				'separator' => 'before',
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'no',
				'condition' => $dependency
...
if(!function_exists('unique_addons_get_swiper_slider_nav_arraylist')) {
	/**
	 * Return Owl Slider Nav Array List
	 */
	function unique_addons_get_swiper_slider_nav_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();
		$control_object->start_controls_section(
			'swiper_arrow_styling', [
				'label' => esc_html__( 'Carousel/Slider Arrow Styling', 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_responsive_control(
			"swiper_arrow_display_visibility", [
				'label' => esc_html__( "Visibility (Show/Hide)", 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow BG Options', 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Color", 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Theme Color", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Text Options', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Color", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Theme Color", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Size & Border', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Arrow Opacity', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Color (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow BG Theme Color (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Color (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "Arrow Text Theme Color (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Border (Hover)', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
...
if(!function_exists('unique_addons_get_swiper_slider_dots_arraylist')) {
	/**
	 * Return Owl Slider Bullets/Dots List
	 */
	function unique_addons_get_swiper_slider_dots_arraylist( $control_object, $serial, $prefix = '', $dependency = array() ) {
		$array = array();

		$control_object->start_controls_section(
			'swiper_dots_options', [
				'label' => esc_html__( 'Carousel/Slider Dots Styling', 'siddik-layout-widgets-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
				'condition' => $dependency
			]
		);
		$control_object->add_responsive_control(
			$prefix . "dots_display_visibility", [
				'label' => esc_html__( "Visibility in Responsive (Show/Hide)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'block' => [
						'title' => __( 'Show', 'siddik-layout-widgets-elementor' ),
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots Position', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$control_object->add_control(
			$prefix . 'swiper_dots_pos_center', [
				'label' => esc_html__( "Dots Position Horizontal Center", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullets/Dots BG Options', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'Bullet Size', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Color (Active)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( "BG Theme Color (Active)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'selectors' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Width (Active)', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$control_object->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Height (Active)', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
...
if(!function_exists('unique_addons_gsap_animation_arraylist')) {
	/**
	 * Return GSAP Animation Array List
	 */
	function unique_addons_gsap_animation_arraylist( $control_object, $prefix = '', $dependency = array() ) {
		$array = array();

		$control_object->add_control(
			'gsap_scrolling_effect',
			[
				'label' => esc_html__( "GSAP Scrolling Effect", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'' => esc_html__('None', 'siddik-layout-widgets-elementor'),
					'parallax' => esc_html__('GSAP Parallax', 'siddik-layout-widgets-elementor'),
				],
				'default' => ''
			]
		);
		$control_object->add_control(
			...
			[
				'label' => esc_html__( 'GSAP Motion Animation', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
				'label_off' => esc_html__( 'Default', 'siddik-layout-widgets-elementor' ),
				'label_on' => esc_html__( 'Custom', 'siddik-layout-widgets-elementor' ),
				'return_value' => 'yes',
		...
		$control_object->add_responsive_control(
			'gsap_motion_x',
			[
				'label' => esc_html__( "X", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => ''
			]
		);
		$control_object->add_responsive_control(
			'gsap_motion_y',
			[
				'label' => esc_html__( "Y", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => ''
			]
		);
		...
		$control_object->add_responsive_control(
			'affectedRange',
			[
				'label' => esc_html__( 'Viewport', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'default' => [
					'sizes' => [
						'start' => 0,
				...
				'labels' => [
					__( 'Bottom', 'siddik-layout-widgets-elementor' ),
					__( 'Top', 'siddik-layout-widgets-elementor' ),
				],
				'scales' => 1,
				'handles' => 'range',
			]
...
if(!function_exists('unique_addons_gsap_animation_json_data')) {
	/**
	 * Return GSAP Animation Array List
	 */
	function unique_addons_gsap_animation_json_data( $item ) {
