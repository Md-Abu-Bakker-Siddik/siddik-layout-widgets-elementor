...
<?php if ( $testimonial_items_array ) : ?>
	<div id="<?php echo esc_attr( $holder_id ) ?>" class="tm-sc-testimonials testimonial-item tm-testimonial-single-carousel" <?php unique_addons_print_pre_escaped_html_attrs( $swiper_slide_data_info ); ?>>
