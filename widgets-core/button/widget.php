...
class TM_Elementor_Button extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Button', 'siddik-layout-widgets-elementor' );
	}
	...
	protected function register_controls() {
		...
		//add button controns
		unique_addons_get_button_control($this);
		...
		$this->add_control(
			'add_icon',
			[
				'label' => esc_html__( "Show/Hide Icon?", 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'button_icon_left',
			[
				'label' => esc_html__( 'Icon Left', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'button_icon_right',
			[
				'label' => esc_html__( 'Icon Right', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::ICONS,
				'separator' => 'before',
				'fa4compatibility' => 'icon',
				'default' => [
	...
	protected function render() {
		...
		$html = unique_addons_get_widgetcore_template_part( 'button', null, 'button/tpl', $settings, true );
