<?php
namespace UniqueAddons\Widgets\Blog\Skins;
...
class Skin_Vertical_List extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-blog/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function get_title() {
		return __( 'Style - Vertical List', 'siddik-layout-widgets-elementor' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			'vertical_list-options', [
				'label' => esc_html__( 'Vertical List Options', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'thumb_options',
			[
				'label' => esc_html__( 'Thumb Options', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_responsive_control(
			'thumb_border_radius',
			[
				'label' => esc_html__( 'Thumb Border Radius', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_control(
			'margin_options',
			[
				'label' => esc_html__( 'Padding/Margin Options', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
			]
		);
		$this->add_responsive_control(
			'padding',
			[
				'label' => esc_html__( 'List Padding', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'margin',
			[
				'label' => esc_html__( 'List Margin', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Last Item', 'siddik-layout-widgets-elementor'),
			]
		);
		$this->add_control(
	...
	public function render_output( $class_instance, $settings ) {
		...
		$html = unique_addons_get_cpt_shortcode_template_part( 'blog', $settings['_skin'], 'blog/tpl/design-style', $settings, true );
