...
class Skin_Style_Current_Theme2 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme2', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme2', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme2' . $direction_suffix . '.css' );
