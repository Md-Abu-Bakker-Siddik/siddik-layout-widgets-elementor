...
class Skin_Style6 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style6', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style6' . $direction_suffix . '.css' );
		...
		$html = unique_addons_get_shortcode_template_part( 'counter-skin-style6', null, 'counter-block/tpl', $settings, true );
