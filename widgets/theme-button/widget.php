<?php
namespace UniqueAddons\Widgets\ThemeButton;
...
class TM_Elementor_Theme_Button extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-theme-button-style', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Theme Button - Siddik Layout Widgets', 'siddik-layout-widgets-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'button_icon',
			[
				'label' => esc_html__( 'Button Icon', 'siddik-layout-widgets-elementor' ),
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'tm-theme-button-style1', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/theme-button/theme-button-style1' . $direction_suffix . '.css' );
		...
		$html = unique_addons_get_shortcode_template_part( 'theme-button-skin-default', null, 'theme-button/tpl', $settings, true );
