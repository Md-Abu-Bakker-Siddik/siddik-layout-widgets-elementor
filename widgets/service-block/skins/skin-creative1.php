<?php
namespace UniqueAddons\Widgets\ServiceBlock\Skins;
...
class Skin_Creative1 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-service-block/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
	...
	public function get_title() {
		return __( 'Skin Creative 1', 'siddik-layout-widgets-elementor' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Skin Styling', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Color Options', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Each Item Options', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Hover/Active', 'siddik-layout-widgets-elementor'),
			]
		);
		$this->add_responsive_control(
	...
	public function render() {
		...
		wp_enqueue_style( 'service-block-creative1', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/service-block/service-block-creative1' . $direction_suffix . '.css' );
		wp_register_script( 'service-block-creative1', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/service-block-creative1.js', array( 'jquery' ), false, true );
		...
		$html = unique_addons_get_shortcode_template_part( 'service-item', $settings['_skin'], 'service-block/tpl', $settings, true );
