...
class Skin_style4 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 4', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style4', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin4' . $direction_suffix . '.css' );
