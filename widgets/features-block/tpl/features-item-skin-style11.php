...
if( empty($image[0])) {
  $image[0] = UNIQUE_ADDONS_ASSETS_URI . '/images/current-theme/icon-shape-9.png';
}
?>
  ...
  <div class="info-box-wrapper">
    ...
    <div class="info-text">
      ...
      <?php if ( $show_view_details_button == 'yes' ) : ?>
        <?php unique_addons_get_shortcode_template_part( 'button', null, 'info-box/tpl', $settings, false );?>
      <?php endif; ?>
    </div>
