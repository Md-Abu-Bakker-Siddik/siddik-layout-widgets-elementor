...
?>
	<<?php echo esc_attr( $title_tag ); ?> class="title <?php echo esc_attr( implode( ' ', $title_classes ) ); ?>" <?php echo wp_kses_post( $title_mouse_helper ); ?><?php if ( isset( $enable_gsap_text_reveal ) && 'yes' === $enable_gsap_text_reveal && isset( $gsap_text_reveal_opacity ) && ! empty( $gsap_text_reveal_opacity['size'] ) ) { ?> data-reveal-opacity="<?php echo esc_attr( $gsap_text_reveal_opacity['size'] ); ?>"<?php } ?><?php if ( isset( $enable_gsap_text_reveal ) && 'yes' === $enable_gsap_text_reveal && isset( $gsap_text_reveal_x ) && ! empty( $gsap_text_reveal_x['size'] ) ) { ?> data-reveal-x="<?php echo esc_attr( $gsap_text_reveal_x['size'] ); ?>"<?php } ?>>
