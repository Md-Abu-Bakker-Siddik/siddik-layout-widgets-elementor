<?php
namespace UniqueAddons\Widgets\ServiceBlock;
...
class TM_Elementor_ServiceBlock extends Widget_Base {
	public function __construct($data = [], $args = null) {
		...
		if( \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
			...
			wp_enqueue_style( 'tm-service-block-loader', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/service-block/service-block-loader' . $direction_suffix . '.css' );
		}
	}
	...
	public function get_title() {
		return esc_html__( 'Service Block', 'siddik-layout-widgets-elementor' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icons_options', [
				'label' => esc_html__( 'Service Items', 'siddik-layout-widgets-elementor' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Service Icon Section', 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$repeater->add_control(
			'icon_type',
			[
				'label' => esc_html__( "Service Icon Type", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
		...
		$repeater->add_control(
			'service_icon_image',
			[
				'label' => esc_html__( "Icon Type - Image", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'description' => esc_html__( "This image will be shown on the top of the pricing table", 'siddik-layout-widgets-elementor' ),
				'condition' => [
					'icon_type' => array('image')
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( "Icon Type - Image Size", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_get_available_image_sizes(),
				'default' => 'full',
				'condition' => [
		...
		$repeater->add_responsive_control(
			...
			[
				'label' => esc_html__( "Icon Image Custom Width", 'siddik-layout-widgets-elementor' ),
		...
		$this->add_control(
			'display_type', [
				...
				'options' => [
					...
					'basic2'  =>  esc_html__( 'Basic2', 'siddik-layout-widgets-elementor' ),
					'creative-style1'  =>  esc_html__( 'Creative Style1', 'siddik-layout-widgets-elementor' )
				],
				'default' => 'grid'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'GSAP Pin Settings', 'siddik-layout-widgets-elementor' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
			'tm_gsap_pin', [
				'label' => esc_html__( "Enable GSAP Pin", 'siddik-layout-widgets-elementor' ),
				'description' => esc_html__( "In that case, please enable Display Type - Basic", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'yes'  =>  esc_html__( 'Yes', 'siddik-layout-widgets-elementor' ),
	...
	protected function render() {
		...
		$direction_suffix = is_rtl() ? '.rtl' : '';
		wp_enqueue_style( 'service-block-style1', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/service-block/service-block-style1' . $direction_suffix . '.css' );
		...
		$settings['holder_id'] = unique_addons_get_isotope_holder_ID('service-block');

		$settings['settings'] = $settings;


		//Produce HTML version by using the parameters (filename, variation, folder name, parameters, shortcode_ob_start)
		$html = unique_addons_get_shortcode_template_part( 'service', $settings['display_type'], 'service-block/tpl', $settings, true );
