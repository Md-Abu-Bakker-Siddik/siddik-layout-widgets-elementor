...
?>
  <div class="features-block-style8">
    <div class="thumb">
      <?php unique_addons_get_shortcode_template_part( 'part-featured-image', null, 'features-block/tpl', $features_item, false );?>
    </div>
    <div class="content">
      ...
      <?php if ( $show_view_details_button == 'yes' ) : ?>
        <?php unique_addons_get_shortcode_template_part( 'button', null, 'services/tpl', $params, false ); ?>
      <?php endif; ?>
    </div>
