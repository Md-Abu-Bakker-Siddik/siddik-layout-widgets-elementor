...
class Skin_Style7 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style7', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style7' . $direction_suffix . '.css' );
		...
		$html = unique_addons_get_shortcode_template_part( 'counter-skin-style7', null, 'counter-block/tpl', $settings, true );
