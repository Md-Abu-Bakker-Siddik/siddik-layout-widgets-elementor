...
<?php if ( $testimonial_items_array ) : ?>
	<div id="<?php echo esc_attr( $holder_id ) ?>" class="tm-sc-testimonials tm-testimonial-carousel tm-swiper-container" <?php unique_addons_print_pre_escaped_html_attrs( $swiper_slide_data_info ); ?>>
