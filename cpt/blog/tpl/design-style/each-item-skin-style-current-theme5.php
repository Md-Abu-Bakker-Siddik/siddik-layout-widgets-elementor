...
<div class="blog-item-current-style5">
  <div class="inner-box">
        ...
        <?php
          ...
          if ( in_array( $show_post_meta_over_featured_image, $post_meta_options_array ) ) {
            ...
            <div class="post-single-meta">
              <?php unique_addons_post_shortcode_single_meta( $show_post_meta_over_featured_image ); ?>
            </div>
            <?php
          }
        ?>
    ...
    <div class="entry-content">
      ...
      <?php if ( $show_post_meta == 'yes' ) : ?>
        <?php unique_addons_post_shortcode_meta( $post_meta_options, array( $show_post_meta_over_featured_image ) ); ?>
      <?php endif; ?>

      <?php if ( $show_view_details_button == 'yes' ) : ?>
        <?php unique_addons_get_cpt_shortcode_template_part( 'button', null, 'blog/tpl/post-format', $settings, false );?>
      <?php endif; ?>
    </div>
  </div>
</div>