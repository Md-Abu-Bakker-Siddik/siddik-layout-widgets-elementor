...
<?php
	...
	wp_enqueue_style( 'service-creative-style1', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/service-block/service-creative-style1' . $direction_suffix . '.css' );
	wp_register_script( 'service-creative-style1', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/service-creative-style1.js', array( 'jquery' ), false, true );
