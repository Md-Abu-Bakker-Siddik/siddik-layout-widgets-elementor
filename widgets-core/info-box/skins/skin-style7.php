...
class Skin_style7 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 7', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style7', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin7' . $direction_suffix . '.css' );
