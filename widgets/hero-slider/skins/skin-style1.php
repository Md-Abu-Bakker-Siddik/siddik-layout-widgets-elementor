<?php
namespace UniqueAddons\Widgets\HeroSlider\Skins;
...
class Skin_Style1 extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/uae-hero-slider/tm_general/after_section_end', [ $this, 'register_layout_controls' ] );
	}
