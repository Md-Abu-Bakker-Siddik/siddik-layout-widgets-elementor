...
class Skin_Style_Current_Theme5 extends Elementor_Skin_Base {
	...
	public function get_id() {
		return 'skin-style-current-theme5';
	}


	public function get_title() {
		return __( 'Skin - Style Current Theme5', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme5', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme5' . $direction_suffix . '.css' );
