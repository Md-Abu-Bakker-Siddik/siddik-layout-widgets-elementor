...
class Skin_Style_Current_Theme3 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme3', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme3', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme3' . $direction_suffix . '.css' );
