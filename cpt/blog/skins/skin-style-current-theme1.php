...
class Skin_Style_Current_Theme1 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style Current Theme1', 'siddik-layout-widgets-elementor' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Wrapper Styling', 'siddik-layout-widgets-elementor' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( "Custom Border Color", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-blog-skin-style-current-theme1', UNIQUE_ADDONS_ASSETS_URI . '/css/cpt/blog/blog-skin-style-current-theme1' . $direction_suffix . '.css' );
