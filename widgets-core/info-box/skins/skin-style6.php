...
class Skin_style6 extends Elementor_Skin_Base {
	...
	public function get_title() {
		return __( 'Skin - Style 6', 'siddik-layout-widgets-elementor' );
	}
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-info-box-style6', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/info-box/info-box-skin6' . $direction_suffix . '.css' );
