...
class TM_Elementor_Contact_Form_7 extends Widget_Base {
    public function __construct($data = [], $args = null) {
        ...
        wp_register_style( 'tm-contact-form-7-style', UNIQUE_ADDONS_ASSETS_URI . '/css/widgets-core/contact-form-7' . $direction_suffix . '.css' );
    }
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'siddik-layout-widgets-elementor' );
	}
	...
	protected function register_controls() {
		...
		if (!function_exists('wpcf7')) {
			$this->start_controls_section(
				'tm_global_warning',
				[
					'label' => esc_html__('Warning!', 'siddik-layout-widgets-elementor'),
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'raw' => esc_html__('<strong>Contact Form 7</strong> is not installed/activated on your site. Please install and activate <strong>Contact Form 7</strong> first.', 'siddik-layout-widgets-elementor'),
			...
			$this->start_controls_section(
				'section_info_box',
				[
					'label' => esc_html__('Contact Form', 'siddik-layout-widgets-elementor'),
				]
			);
			$this->add_control(
				'contact_form_list',
				[
					'label' => esc_html__('Select Form', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SELECT,
					'label_block' => true,
					'options' => unique_addons_get_wpcf7_list(),
					'default' => '0',
				]
			);
			$this->add_control(
				'labels_switch',
				[
					'label' => esc_html__('Show Labels', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'label_on' => esc_html__('Show', 'siddik-layout-widgets-elementor'),
					'label_off' => esc_html__('Hide', 'siddik-layout-widgets-elementor'),
					'return_value' => 'yes',
				]
			);
			$this->end_controls_section();
			...
			$this->add_control(
				'form_subtitle',
				[
					'label' => esc_html__('Form Sub Title', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SWITCHER,
			...
			$this->add_control(
				'form_title',
				[
					'label' => esc_html__('Form Title', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'siddik-layout-widgets-elementor'),
					'label_off' => esc_html__('Off', 'siddik-layout-widgets-elementor'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				...
				[
					'label' => esc_html__('Description', 'siddik-layout-widgets-elementor'),
				]
			);
			$this->add_control(
				'form_description',
				[
					'label' => esc_html__('Form Description', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SWITCHER,
					'label_on' => esc_html__('On', 'siddik-layout-widgets-elementor'),
					'label_off' => esc_html__('Off', 'siddik-layout-widgets-elementor'),
					'return_value' => 'yes',
			...
			$this->start_controls_section(
				'section_errors',
				[
					'label' => esc_html__('Errors', 'siddik-layout-widgets-elementor'),
				]
			);
			...
			$this->add_control(
				'error_messages',
				[
					'label' => esc_html__('Error Messages', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'siddik-layout-widgets-elementor'),
						'hide' => esc_html__('Hide', 'siddik-layout-widgets-elementor'),
					],
			...
			$this->add_control(
				'validation_errors',
				[
					'label' => esc_html__('Validation Errors', 'siddik-layout-widgets-elementor'),
					'type' => Controls_Manager::SELECT,
					'default' => 'show',
					'options' => [
						'show' => esc_html__('Show', 'siddik-layout-widgets-elementor'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Form Container', 'siddik-layout-widgets-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( "Background Theme Colored (Hover)", 'siddik-layout-widgets-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => unique_addons_theme_color_list(),
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Alignment', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'default' => [
						'title' => esc_html__('Default', 'siddik-layout-widgets-elementor'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Max Width', 'siddik-layout-widgets-elementor'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Form Padding', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => ['px', 'em', '%'],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Title & Description', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Heading Wrapper Style', 'siddik-layout-widgets-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form Wrapper Style', 'siddik-layout-widgets-elementor' ),
				'tab'   => \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Only Select/Dropdown Field', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Dropdown Arrow Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Placeholder Text Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Input, Select & Textarea', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			'text_indent',
			[
				'label' => esc_html__('Text Indent', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_width',
			[
				'label' => esc_html__('Input Width', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'input_height',
			[
				'label' => esc_html__('Input Height', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_width',
			[
				'label' => esc_html__('Textarea Width', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'textarea_height',
			[
				'label' => esc_html__('Textarea Height', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'tab_fields_focus',
			[
				'label' => esc_html__('Focus', 'siddik-layout-widgets-elementor'),
			]
		);
		...
		$this->start_controls_section(
			'section_label_style',
			[
				'label' => esc_html__('Labels', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'labels_switch' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'raw' => esc_html__('if label spacing doesn\'t worked, please update label display', 'siddik-layout-widgets-elementor'),
				'content_classes' => 'tm-warning',
			]
		);
		$this->add_control(
			'label_disply_type',
			[
				'label' => esc_html__('Display', 'siddik-layout-widgets-elementor'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
		...
		$this->add_responsive_control(
			'label_spacing',
			[
				'label' => esc_html__('Spacing', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Placeholder', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'placeholder_switch',
			[
				'label' => esc_html__('Show Placeholder', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Radio & Checkbox', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Custom Styles', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('Yes', 'siddik-layout-widgets-elementor'),
				'label_off' => esc_html__('No', 'siddik-layout-widgets-elementor'),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'radio_checkbox_size',
			[
				'label' => esc_html__('Size', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => '15',
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Border Width', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'checkbox_heading',
			[
				'label' => esc_html__('Checkbox', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->add_control(
			'radio_heading',
			[
				'label' => esc_html__('Radio Buttons', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Checked', 'siddik-layout-widgets-elementor'),
				'condition' => [
					'custom_radio_checkbox' => 'yes',
				],
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => 'custom',
				'options' => [
					'full-width' => esc_html__('Full Width', 'siddik-layout-widgets-elementor'),
					'custom' => esc_html__('Custom', 'siddik-layout-widgets-elementor'),
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Submit Button Position', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
		...
		$this->start_controls_section(
			'spinner_icon_style',
			[
				'label' => esc_html__('After Submit Spinner Icon', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_wpcf7_spinner',
			[
				'label' => esc_html__( 'Hide Spinner Icon', 'siddik-layout-widgets-elementor' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Progress Range Styling (Optional)', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__('Label/Title Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Label/Title Typography', 'siddik-layout-widgets-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Amount Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Amount Typography', 'siddik-layout-widgets-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Progress Background Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Background Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__('Bar Border', 'siddik-layout-widgets-elementor'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Bar Handle Background Color', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Alert', 'siddik-layout-widgets-elementor'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_tab(
			...
			[
				'label' => esc_html__('Fields', 'siddik-layout-widgets-elementor'),
				'condition' => [
					'error_messages' => 'show',
				],
			]
		...
		$this->start_controls_section(
			'ajaxloader_style',
			[
				'label' => esc_html__('Ajax Loader Image', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
			'hide_ajaxloader',
			[
				'label' => esc_html__('Hide Ajax Loader Image', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('After Submit Feedback', 'siddik-layout-widgets-elementor'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Radius', 'siddik-layout-widgets-elementor'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', 'em', '%'],
				'range' => [
					'px' => [
	...
	protected function render2() {
		...
		//$html = unique_addons_get_widgetcore_template_part( 'wpcf7', null, 'wpcf7/tpl', $settings, true );
