...
class SLWE_Imgselect extends \Elementor\Base_Data_Control {
    ...
    public function enqueue() {
		// Styles
		wp_register_style( 'tm-elementor-base', UNIQUE_ADDONS_ASSETS_URI . '/section-col-stretch/tm-stretch-base.css' );
