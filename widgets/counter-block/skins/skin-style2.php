...
class Skin_Style2 extends Elementor_Skin_Base {
	...
	public function render() {
		...
		wp_enqueue_style( 'tm-counter-block-style2', UNIQUE_ADDONS_ASSETS_URI . '/css/shortcodes/counter-block/counter-block-style2' . $direction_suffix . '.css' );

		wp_enqueue_script( 'tm-counter-block-script', UNIQUE_ADDONS_ASSETS_URI . '/js/widgets/counter-block.js', array('jquery'), false, true );
		...
		$html = unique_addons_get_shortcode_template_part( 'counter-skin-style2', null, 'counter-block/tpl', $settings, true );
